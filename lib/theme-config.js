 ...
 * @returns {ThemeConfig}
 */
function getInstance(themePath, configPath) {
    if (!themeConfigInstance) {
        themeConfigInstance = new ThemeConfig(themePath, configPath);

        return themeConfigInstance;
    }

    if (themePath) {
        themeConfigInstance.setThemePath(themePath, configPath);
    }
 ...
 * @constructor
 */
function ThemeConfig(themePath, configPath) {
    if (themePath) {
        this.setThemePath(themePath, configPath);
    }
 ...
 * @returns {ThemeConfig}
 */
ThemeConfig.prototype.setThemePath = function (themePath, configPath) {
    this.themePath = themePath;
    if( configPath ) {
      this.configPath = Path.join(themePath, configPath);
    } else {
